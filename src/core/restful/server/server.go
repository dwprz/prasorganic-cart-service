...
import (
	...
	"github.com/dwprz/prasorganic-cart-service/src/core/restful/router"
...
type Restful struct {
	app                *fiber.App
	cartRestfulHandler *handler.Cart
	middleware         *middleware.Middleware
}

func New(crh *handler.Cart, m *middleware.Middleware) *Restful {
